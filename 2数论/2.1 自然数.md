...
- ==定理== **乘法运算律**：
	...
	- 结合律
		...
		>$同加法$
	- 分配律
		- $(b\pm c)*a=b*a\pm c*a=a*(b\pm c)=a*b\pm a*c$
		>$\begin{cases}0*(b\pm c)=0=0*b\pm 0*c&a=0\\k*(b\pm c)=k*b\pm k*c&a=k\\(k+1)*(b\pm c)=k*(b\pm c)+b\pm c=k*b\pm k*c+ b\pm c=k*b+b\pm (k*c+c)=(k+1)*b\pm (k+1)*c&a=k+1\end{cases}$
		- $b/a\pm c/a=(b\pm c)/a$
		>$b/a\pm c/a=(b/a\pm c/a)*a/a=(b\pm c)/a$
		- $a/b\pm c/d=(a*d\pm b*c)/b*d$
		>$a/b\pm c/d=(a*d)/(b*d)\pm (c*b)/(d*b)=(a*d\pm b*c)/b*d$
